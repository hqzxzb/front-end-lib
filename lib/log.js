...
var log = {
     ...
     * @return   {[type]}                    [description]
     * @author ZHAOBO
     * @datetime 2016-12-18T21:59:45+080
     */
    output: function(msg, e) {
        console.log(msg, e);
    },
    ...
    fatal: function(msg, e) {
        if (this.isEnabled(this.levelKey.FATAL))
            this.output(this.format(msg, this.levelKey.FATAL), typeof e !== 'undefined' ? e : "");
    },
    /**
     * Error Log
     * @param    {[type]}                msg [description]
    ...
    error: function(msg, e) {
        if (this.isEnabled(this.levelKey.ERROR))
            this.output(this.format(msg, this.levelKey.ERROR), typeof e !== 'undefined' ? e : "");
    },
    /**
     * Warn Log
     * @param    {[type]}                msg [description]
    ...
    warn: function(msg, e) {
        if (this.isEnabled(this.levelKey.WARN))
            this.output(this.format(msg, this.levelKey.WARN), typeof e !== 'undefined' ? e : "");
    },
    /**
     * Info Log
     * @param    {[type]}                msg [description]
    ...
    info: function(msg, e) {
        if (this.isEnabled(this.levelKey.INFO))
            this.output(this.format(msg, this.levelKey.INFO), typeof e !== 'undefined' ? e : "");
    },
    /**
     * Debug Log
     * @param    {[type]}                msg [description]
    ...
    debug: function(msg, e) {
        if (this.isEnabled(this.levelKey.DEBUG))
            this.output(this.format(msg, this.levelKey.DEBUG), typeof e !== 'undefined' ? e : "");
    },
    /**
     * Trace Log
     * @param    {[type]}                msg [description]
    ...
    trace: function(msg, e) {
        if (this.isEnabled(this.levelKey.TRACE))
            this.output(this.format(msg, this.levelKey.TRACE), typeof e !== 'undefined' ? e : "");
    }
};
